...
public class PacMan extends SimState
    ...
    public static int NUM_OF_GHOSTS = 1;
    ...
    public static void setGhostCount(int number)
    {
    	NUM_OF_GHOSTS = number;
    }
    ...
    //	int NUM_OF_GHOSTS = 4;
        ...
        pacs = new Pac[NUM_OF_PLAYERS];  // set this to Pac[1] to make this one-player
        ...
        if(NUM_OF_GHOSTS == 2 || NUM_OF_GHOSTS == 3 || NUM_OF_GHOSTS == 4)
        {
        Pinky pinky = new Pinky(this);
        }
  
        
        if(NUM_OF_GHOSTS == 3 || NUM_OF_GHOSTS == 4)
        {
